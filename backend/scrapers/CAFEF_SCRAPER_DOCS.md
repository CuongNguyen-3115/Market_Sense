...
## 1. Thông tin chung
- **Đường dẫn file:** `market_sense/scrapers/cafef_scraper.py`
...
4. **Data Streaming:** Đóng gói dữ liệu thành chuẩn JSON và bắn trực tiếp (Streaming) vào Kafka Topic `raw-news` thông qua cổng `9092`.

...
def process_sentiment():
    ...
    system_prompt = """Bạn là một Chuyên gia phân tích rủi ro tài chính định lượng tại quỹ đầu tư.
        ...
        for attempt in range(max_retries):
            try:
                ...
                if "429" in error_msg or "rate limit" in error_msg.lower() or "too many requests" in error_msg.lower():
                    ...
                    logger.warning(f"🚨 Gặp lỗi 400 Bad Request (Model hiện tại không hỗ trợ JSON schema hoặc nội dung lỗi). Lập tức nhảy sang HuggingFace!")
                    current_provider = "hf"
                    time.sleep(1)
